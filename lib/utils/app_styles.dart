...
class Styles{
  ...
  static TextStyle headLineStyle2 = TextStyle(fontSize: 17, color: textColor, fontWeight: FontWeight.bold);
  static TextStyle headLineStyle3 = TextStyle(fontSize: 21, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
